    ...
    return <div className={styles.body}>
        ...
        <div className={styles.rightContent}>
            ...
            <div className={styles.loginBox}>
                ...
                {badEmail ?<div className={styles.errorMessage}><Image className={styles.errorImage} alt="error" src={error}/>{badEmail}</div>: <div></div>}
            </div>
            <div className={styles.loginBox}>
                Password <br></br>
                ...
                {badPassword ? <div className={styles.errorMessage}><Image className={styles.errorImage} alt="error" src={error}/>{badPassword}</div> : <div></div>}
            </div>
