...
/**
 * Defines each page and the authentication status they require to access the page.
 * - "authenticated" requires the user to be authenticated,
 * - "unauthenticated" requires the user to be unauthenticated,
 * - undefined is agnostic to user authentication status
 */
const pageRequiredAuthentication: Record<
  Pages,
